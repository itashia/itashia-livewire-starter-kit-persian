...
>
    ...
    <div class="relative hidden space-y-[2px] pe-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] end-0 me-4 w-px bg-zinc-200 dark:bg-white/30"></div>
